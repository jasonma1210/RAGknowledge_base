...
public class SearchController {
    ...
    public ResponseEntity<?> searchKnowledgeBase(@Valid @RequestBody SearchRequest request, 
        ...
        try {
            ...
            PageResult<SearchResult> pageResult = ragService.searchKnowledgeBase(request, currentUser, page, size);
...
//                                        HttpServletRequest httpRequest) {
    public ResponseEntity<?> askQuestion(@RequestBody QuestionRequest questionRequest,
        ...
        try {
            ...
            Map<String, Object> response = ragService.askQuestion(questionRequest.getQuestion(), searchRequest, currentUser);
